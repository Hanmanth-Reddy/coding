...
# sudo yum update -y && \
#     sudo yum install -y wget ca-certificates zip net-tools vim nano tar nc


sudo dnf update -y && \
    sudo dnf install -y wget ca-certificates zip net-tools vim nano tar nc


### Java Open JDK 8
## update-alternatives --list java
# sudo yum list available "java-*-openjdk-devel"
